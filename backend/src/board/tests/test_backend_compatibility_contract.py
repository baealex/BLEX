...
EXPECTED_ROUTE_CONTRACT = (
    ...
    ('v1/setting/trash-posts', None, 'board.views.api.v1.post_trash.trashed_posts'),
    ('v1/setting/trash-posts/<url>', None, 'board.views.api.v1.post_trash.trashed_posts'),
    (
        'v1/setting/trash-posts/<url>/restore',
        None,
        'board.views.api.v1.post_trash.restore_trashed_post',
    ),
...
EXPECTED_MODEL_TABLES = (
    ...
    ('UtilityCleanupConfirmation', 'board_utilitycleanupconfirmation'),
