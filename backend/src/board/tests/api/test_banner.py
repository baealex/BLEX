...
from board.models import User, Profile, Banner
...
class BannerAPITestCase(TestCase):
    ...
    def test_create_banner(self):
        ...
        # 배너가 DB에 생성되었는지 확인
        banner = Banner.objects.get(title='Test Banner')
    ...
    def test_delete_banner(self):
        ...
        # DB에서 삭제되었는지 확인
        self.assertFalse(Banner.objects.filter(id=banner.id).exists())
    ...
    def test_user_cannot_access_other_user_banner(self):
        ...
        other_banner = Banner.objects.create(
            user=other_user,
            title='Other Banner',
