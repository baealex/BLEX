...
class SearchAPITestCase(TestCase):
    ...
    def test_search_with_pagination(self):
        ...
        self.assertEqual(response.status_code, 200)
        content = json.loads(response.content)
        self.assertIn('last_page', content['body'])
        self.assertIn('results', content['body'])
    ...
    def test_search_returns_metadata(self):
        ...
        self.assertIn('elapsed_time', content['body'])
        self.assertIn('total_size', content['body'])
    ...
    def test_search_no_results(self):
        ...
        self.assertEqual(content['body']['total_size'], 0)
