                                ...
                                {title && (
                                    <div className="space-y-4">
                                        ...
                                        <div className="border border-gray-200 rounded-xl p-4 bg-white">
                                            ...
                                            <div className="text-blue-600 text-sm hover:underline cursor-default line-clamp-1">
                                                {title || '제목을 입력하세요'}
                                            </div>
                                            <div className="text-green-700 text-xs mt-0.5 mb-1">
                                                blex.me › @username › {url || 'post-url'}
                                            </div>
                                            <div className="text-gray-600 text-xs line-clamp-2 leading-relaxed">
                                                {metaDescription || '검색 결과에 표시될 설명을 입력하세요...'}
                                            </div>
                                        </div>

                                        {/* Twitter/X Card Preview */}
                                        <div className="border border-gray-200 rounded-xl overflow-hidden bg-white">
                                            <div className="text-xs text-gray-500 p-3 pb-2 flex items-center gap-1">
                                                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                                                </svg>
                                                Twitter/X 카드
                                            </div>
                                            <div className="aspect-[2/1] bg-gray-100 border-t border-b border-gray-200 flex items-center justify-center">
                                                <svg className="w-12 h-12 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                </svg>
                                            </div>
                                            <div className="p-3 bg-white">
                                                <div className="text-gray-500 text-xs mb-1">blex.me</div>
                                                <div className="text-gray-900 text-sm font-medium line-clamp-1">
                                                    {title || '제목을 입력하세요'}
                                                </div>
                                                <div className="text-gray-600 text-xs mt-1 line-clamp-1">
                                                    {metaDescription || '설명을 입력하세요'}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
