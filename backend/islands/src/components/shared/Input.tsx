...
const Input = forwardRef<HTMLInputElement | HTMLTextAreaElement, InputProps>(
    (
        ...
        const baseInputStyles = 'block w-full rounded-md border border-gray-200 shadow-sm focus:border-gray-500 focus:ring-gray-500 text-sm p-3 transition-colors';
        const errorStyles = error ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : '';

        const leftPadding = leftIcon && !label ? 'pl-10' : '';
