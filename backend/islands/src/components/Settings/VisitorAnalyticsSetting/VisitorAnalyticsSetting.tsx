                        ...
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{views.body.total.toLocaleString()}</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                        <div className="flex items-center mb-4 sm:mb-0">
                            ...
                            <input
                                ...
                                className="px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm mr-2"
                            />
                            <span className="text-sm font-medium text-gray-700">의 인기글</span>
                        </div>
                    ...
                    {postViews.posts.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {postViews.posts.map((item, index) => (
                                <div key={item.url} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
