    ...
    return (
        <div className="p-4 sm:p-6 bg-white shadow-sm rounded-lg">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                ...
                <p className="text-purple-700 mb-4">다른 에디터로부터 받은 초대 요청을 확인하고 응답하세요.</p>

                <div className="space-y-2">
                    <div className="flex items-center text-sm text-purple-700">
                        <i className="fas fa-check-circle mr-2 text-purple-600" />
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center justify-center w-12 h-12 bg-blue-100 rounded-full flex-shrink-0">
                            <i className="fas fa-inbox text-blue-600 text-xl" />
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold text-blue-900">초대 요청이 없습니다</h3>
                            <p className="text-sm text-blue-700 mt-1">현재 받은 에디터 초대 요청이 없습니다.</p>
                        </div>
                    </div>
                </div>
            ) : (
                        ...
                        <div key={invitation.id} className="bg-gray-50 rounded-lg border border-gray-200 p-4 sm:p-6">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                                ...
                                <div className="flex space-x-3 sm:flex-shrink-0">
                                    <button
                                        type="button"
                                        className="flex-1 sm:flex-none inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors"
                                        onClick={() => respondToInvitation(invitation.id, 'reject')}>
                                        거절
                                    </button>
                                    <button
                                        type="button"
                                        className="flex-1 sm:flex-none inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
                            ...
                            <div>
                                ...
                                <textarea
                                    className="w-full px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
                                    readOnly
                                    rows={3}
